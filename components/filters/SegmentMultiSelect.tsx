...
export function SegmentMultiSelect() {
  ...
  const segmentOptions = useMemo(() => {
    ...
    if (filters.segmentType === 'By End-Use*Product Type') {
    ...
    let items: string[] = []
    if (filters.segmentType === 'By End-Use*Product Type' && (filters.businessType === 'B2B' || filters.businessType === 'B2C')) {
      ...
      if (filters.businessType === 'B2B' && segmentDimension?.b2b_items) {
        ...
        items = Array.from(allHierarchyItems)
      }
    } else {
